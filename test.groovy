...
def num=9
    ...
    // create CI jobs
    if(num==10) {
      createCIJobforPython('python_job','https://github.com/akshay-hingarajiya/dsl_demo.git','master')   //function call for run python project
    }
    else if(num==9){
        // Pass params accordingly
      createDeployJob('node_demo','https://github.com/akshay-hingarajiya/dsl_demo.git','master')  //function call for run node project 
    }
    else {
